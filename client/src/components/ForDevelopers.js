        ...
        <article id="for-developers">
            <div className="for-developers-text-container">
                ...
                <p className="for-developers-text">
                    <strong>Join me on Github to contribute this project to help people learning Italian!</strong>
                </p>
                <div>
                    <a rel="noreferrer" href="https://github.com/Maxlous/learnItalian" target="_blank">
