...
const Home = () => {
  return (
    <Section>
      <Head>
        <title>Italian with English</title>
        <meta
          name="description"
          content="Learn Italian words and expressions with your English!"
        />
        <meta charset="utf-8" />
      ...
      <Wrapper className="second">
        ...
        <Paragraph>Don't worry, not expecting high level of English.</Paragraph>
      </Wrapper>
